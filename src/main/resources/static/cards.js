...
(function (root, factory) {
    ...
    var module = {
        options: {
            ...
            fanDirection: "N",
            imagesUrl: 'img/' // The base URL for the card images, should end with a '/'.
        },
    ...
    function addCardImages(hand, cards) {
        ...
        hand.empty();
        for (i = 0; i < cards.length; ++i) {
            src = "src='" + module.options.imagesUrl + cards[i] + '.png' + "'";
    ...
    if (cardsScript && cardsScript.src) {
        var path = cardsScript.src.substring(0, cardsScript.src.lastIndexOf('/')) + '/img/';
